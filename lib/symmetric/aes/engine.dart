...
class AESFastEncryptionEngine extends _Common implements BlockCipher {
  ...
  final int blockSize = _block_size;

  AESFastEncryptionEngine._(this._workingKey, this._rounds);

  factory AESFastEncryptionEngine(Uint8List key) {
...
class AESFastDecryptionEngine extends _Common implements BlockCipher {
  ...
  final int blockSize = _blockSize;

  AESFastDecryptionEngine._(this._workingKey, this._rounds);
