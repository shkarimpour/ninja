...
class RSAPublicKey {
  ...
  late RSAEncryptionEngine _engine;
...
class RSAPrivateKey {
  ...
  late RSADecryptionEngine _engine;
  ...
  Iterable<int> decrypt(/* String | List<int> */ input,
    ...
    Uint8List unpadded = Uint8List.fromList(
        engine.process(inputBytes, dontPadLastBlock: raw).toList());
    if (padder == null) {
      return unpadded;
    }
